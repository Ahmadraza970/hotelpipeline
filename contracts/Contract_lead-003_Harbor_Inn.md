# HOTEL WEBSITE & DIRECT BOOKING SYSTEM DEVELOPMENT AGREEMENT

**Agreement Reference:** HBD-LEAD-003-202609  
...
2. **Client / Property Owner:**  
   **Harbor Inn**  
   Attn: Manager  
   Location: Boston, MA  
   Email: owner@harborinn.com | Phone: +1-617-555-0177  
...
- Modern, luxury design optimized for Harbor Inn
...
- **Total Project Fee:** **INR 28,000.00**
- **Milestone 1 (Deposit):** **INR 14,000.00** (50%) due upon signing to initiate design & development.
- **Milestone 2 (Final Balance):** **INR 14,000.00** (50%) due upon final approval and domain launch.
...
Signature: ___________________________  
Name: Manager  
Title: Authorized Signatory for Harbor Inn  
